...
// ─── Portalled City Dropdown ───────────────────────────────────────────────────
function CityDropdown({ anchorRef, search, onSearch, onSelect, selectedCity, excludeCity, onClose }) {
          ...
          <div className="flex flex-wrap gap-1.5">
            {recent.map((c) => (
              <button
                ...
                type="button"
                onClick={() => onSelect(c)}
                className="flex items-center gap-1 px-2.5 py-1 text-xs rounded-full bg-gray-100 text-gray-600 hover:bg-blue-50 hover:text-blue-600 transition-colors"
              >
...
export default function SearchForm() {
  ...
  const sectionBase =
    "flex items-center gap-3 px-5 py-5 hover:bg-gray-50 transition-colors text-left w-full h-full";
    ...
    <>
      ...
      <form onSubmit={handleSearch} className="w-full max-w-6xl">
        ...
        <div className="bg-white rounded-2xl shadow-2xl">
          <div className="flex flex-col lg:flex-row">
            ...
            <div className={`relative flex-1 min-w-0 ${shaking.from ? "nb-shake" : ""}`}>
              ...
              >
                <Bus size={22} className="text-gray-400 flex-shrink-0" />
              ...
              >
                <ArrowLeftRight
                  ...
                  style={{
                    transform:  `rotate(${swapAngle}deg)`,
            ...
            <div className={`relative flex-1 min-w-0 ${shaking.to ? "nb-shake" : ""}`}>
              <button
                ...
                className={`${sectionBase}
                  ${errors.to ? "ring-2 ring-inset ring-red-400" : ""}`}
              >
                <Bus size={22} className="text-gray-400 flex-shrink-0 -scale-x-100" />
                <div className="min-w-0">
              ...
              <button
                type="button"
                onClick={handleSwap}
                className="lg:hidden absolute right-4 top-1/2 -translate-y-1/2 w-8 h-8 bg-gray-800 rounded-full flex items-center justify-center"
              >
            ...
            <div className={`relative flex-[1.5] min-w-0 ${shaking.date ? "nb-shake" : ""}`}>
              ...
              <div className={`flex items-center gap-2 px-5 py-5 hover:bg-gray-50 transition-colors h-full
            ...
            {/* ── BOOKING FOR WOMEN ── */}
            <div className="flex items-center gap-2.5 px-4 py-5 rounded-b-2xl lg:rounded-r-2xl lg:rounded-bl-none hover:bg-gray-50 transition-colors flex-shrink-0">
              ...
              <button
                ...
                className={`relative flex-shrink-0 w-11 h-6 rounded-full transition-colors duration-200
                  ${bookingForWomen ? "bg-gray-800" : "bg-gray-300"}`}
              ...
              >
                <span
                  className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow-md transition-all duration-200
                    ${bookingForWomen ? "left-5" : "left-0.5"}`}
                />
              </button>
            </div>
        ...
        <div className="flex justify-center mt-5">
          <button
            type="submit"
            className="flex items-center gap-2.5 font-semibold text-base text-white px-20 py-3.5 rounded-full shadow-lg active:scale-95 transition-all border-2 border-white/20"
