...
export default function EditRoutePage() {
  ...
  const Field = ({ field, label, required, ...props }) => (
    <div>
      ...
      <div className="space-y-6">
        <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Field field="routeName" label="Route Name" required placeholder="e.g. Mumbai - Pune Express" />
            <Field field="routeNumber" label="Route Number" placeholder="e.g. RT-001" />
            <Field field="origin" label="Origin" required placeholder="e.g. Mumbai" />
            <Field field="destination" label="Destination" required placeholder="e.g. Pune" />
            <Field field="estimatedDuration" label="Estimated Duration" placeholder="e.g. 3h 30m" />
            <Field field="distance" label="Distance (km)" type="number" placeholder="e.g. 150" />
          </div>
          <div className="mt-4">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-semibold text-slate-800">Via Stops</h3>
